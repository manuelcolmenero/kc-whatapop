...
/*
    BluePath: Se crea el pipe 'publicationDate'/'PublicationDatePipe'
    que resuelve, dada una fecha de entrada, el cálculo de tiempo hasta
    la fecha actual.
*/
@Pipe({
...
export class PublicationDatePipe implements PipeTransform {
    transform(publicationDate: Date): string {
